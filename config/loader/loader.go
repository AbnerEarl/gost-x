...
import (
	...
	"github.com/AbnerEarl/gost-x/config/parsing"
	admission_parser "github.com/AbnerEarl/gost-x/config/parsing/admission"
	auth_parser "github.com/AbnerEarl/gost-x/config/parsing/auth"
	bypass_parser "github.com/AbnerEarl/gost-x/config/parsing/bypass"
	chain_parser "github.com/AbnerEarl/gost-x/config/parsing/chain"
	hop_parser "github.com/AbnerEarl/gost-x/config/parsing/hop"
	hosts_parser "github.com/AbnerEarl/gost-x/config/parsing/hosts"
	ingress_parser "github.com/AbnerEarl/gost-x/config/parsing/ingress"
	limiter_parser "github.com/AbnerEarl/gost-x/config/parsing/limiter"
	logger_parser "github.com/AbnerEarl/gost-x/config/parsing/logger"
	observer_parser "github.com/AbnerEarl/gost-x/config/parsing/observer"
	recorder_parser "github.com/AbnerEarl/gost-x/config/parsing/recorder"
	resolver_parser "github.com/AbnerEarl/gost-x/config/parsing/resolver"
	router_parser "github.com/AbnerEarl/gost-x/config/parsing/router"
	sd_parser "github.com/AbnerEarl/gost-x/config/parsing/sd"
	service_parser "github.com/AbnerEarl/gost-x/config/parsing/service"
